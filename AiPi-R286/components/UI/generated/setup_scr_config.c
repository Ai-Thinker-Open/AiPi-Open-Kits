...
static int config_digital_clock_3_hour_value = 23;
static int config_digital_clock_3_min_value = 55;
static int config_digital_clock_3_sec_value = 0;
void config_digital_clock_3_timer(lv_timer_t* timer)
{
	clock_count_24(&config_digital_clock_3_hour_value, &config_digital_clock_3_min_value, &config_digital_clock_3_sec_value);
	if (lv_obj_is_valid(guider_ui.config_digital_clock_3))
	{
		lv_dclock_set_text_fmt(guider_ui.config_digital_clock_3, "%02d:%02d", config_digital_clock_3_hour_value, config_digital_clock_3_min_value);
	}
}
