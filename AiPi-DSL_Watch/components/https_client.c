...
static void get_https_date(char* date)
{
    ...
    if (strcmp(date_wday, "Sun")==0)Home_digital_date_wday_value = 0;
    if (strcmp(date_wday, "Mon")==0)Home_digital_date_wday_value = 1;
    if (strcmp(date_wday, "Tue")==0)Home_digital_date_wday_value = 2;
    if (strcmp(date_wday, "Wed")==0)Home_digital_date_wday_value = 3;
    if (strcmp(date_wday, "Thu")==0)Home_digital_date_wday_value = 4;
    if (strcmp(date_wday, "Fri")==0)Home_digital_date_wday_value = 5;
    if (strcmp(date_wday, "Sat")==0)Home_digital_date_wday_value = 6;
    date_data += 5;

    char* date_day = strtok(date_data, " ");
    Home_digital_date_day_value = atoi(date_day);
    int i = 0;
    while (date_day!=NULL) {
        date_day = strtok(NULL, " ");
        if (i==0) {
            if (strcmp(date_day, "Jan")==0)Home_digital_date_mon_value = 1;
            if (strcmp(date_day, "Feb")==0)Home_digital_date_mon_value = 2;
            if (strcmp(date_day, "Mar")==0)Home_digital_date_mon_value = 3;
            if (strcmp(date_day, "Apr")==0)Home_digital_date_mon_value = 4;
            if (strcmp(date_day, "May")==0)Home_digital_date_mon_value = 5;
            if (strcmp(date_day, "Jun")==0)Home_digital_date_mon_value = 6;
            if (strcmp(date_day, "Jul")==0)Home_digital_date_mon_value = 7;
            if (strcmp(date_day, "Aug")==0)Home_digital_date_mon_value = 8;
            if (strcmp(date_day, "Sept")==0)Home_digital_date_mon_value = 9;
            if (strcmp(date_day, "Oct")==0)Home_digital_date_mon_value = 10;
            if (strcmp(date_day, "Nov")==0)Home_digital_date_mon_value = 11;
            if (strcmp(date_day, "Dec")==0)Home_digital_date_mon_value = 12;
        }
        if (i==1) Home_digital_date_yesr_value = atoi(date_day);

        if (i==2) {
            char* date_s = strtok(date_day, ":");
            Home_digital_clock_1_hour_value = atoi(date_s)+8;
            for (size_t j = 0; j < 2; j++)
            {
                date_s = strtok(NULL, ":");
                if (j==0) Home_digital_clock_1_min_value = atoi(date_s);
                else Home_digital_clock_1_sec_value = atoi(date_s);
            }
        }
        i++;
    }
