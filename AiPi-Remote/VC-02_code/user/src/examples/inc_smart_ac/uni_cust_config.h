...
/*---MIC config---*/
#define UNI_MIC_ARRY_NUM          2
#define UNI_MIC_ARRY_TYPE         UNI_MIC_ARRY_TYPE_LINER
#define UNI_MIC_ARRY_DISTANCE     100

#define DEFAULT_PCM_WAKEUP        "[102, 103]"
#define DEFAULT_PCM_ASR_TIMEOUT   "[101]"
