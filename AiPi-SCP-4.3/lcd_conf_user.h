...
#define LCD_RESET_EN 1
    ...
    /* LCD width and height */
#define ST7796_SPI_W 480
#define ST7796_SPI_H 272
...
#define LCD_SPI_INTERFACE_TYPE 1
    ...
    /* Selecting pixel format
        1: rgb565
    */
#define UE043HV_SPI_PIXEL_FORMAT 1
...
#define LCD_RESET_EN 1
    ...
    /* LCD width and height */
#define UE043HV_SPI_W 480
#define UE043HV_SPI_H 272

/* The offset of the area can be displayed */
#define UE043HV_SPI_OFFSET_X 0
#define UE043HV_SPI_OFFSET_Y 0

/* Color reversal, Some screens are required
    0: disable
    1: enable
*/
#define UE043HV_SPI_COLOR_REVERSAL 0
