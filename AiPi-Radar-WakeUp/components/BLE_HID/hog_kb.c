...
static struct hids_report input_display = {
    .id = 0x03,
    .type = HIDS_INPUT,
};
...
static struct bt_gatt_attr attrs[] = {
    ...
    //普通键盘
    BT_GATT_CHARACTERISTIC(BT_UUID_HIDS_REPORT,BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,BT_GATT_PERM_READ,read_input_report, NULL, NULL),
    ...
    BT_GATT_CHARACTERISTIC(BT_UUID_HIDS_REPORT,BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY,BT_GATT_PERM_READ,read_input_report, NULL, NULL),
    BT_GATT_CCC(input_ccc_changed,BT_GATT_PERM_READ | BT_GATT_PERM_WRITE),
    BT_GATT_DESCRIPTOR(BT_UUID_HIDS_REPORT_REF, BT_GATT_PERM_READ, read_report, NULL, &input_display),
...
int hog_send_keyboard_display(struct bt_conn* conn, key_mask_t special_key_mask)
{
    struct bt_gatt_attr* attr;
