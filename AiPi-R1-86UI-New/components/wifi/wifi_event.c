...
void wifi_event_handler(uint32_t code)
{
    ...
    switch (code) {
        ...
        case CODE_WIFI_ON_MGMR_DONE:
        {
            ...
            device_send_state_notify(DEVICE_STATE_SYSTEM_START, true);
        ...
        case CODE_WIFI_ON_CONNECTED:
        {
            ...
            void mm_sec_keydump();
            mm_sec_keydump();
            device_send_state_notify(DEVICE_STATE_WIFI_CONNECT_OK, true);
        }
        break;
        case CODE_WIFI_ON_GOT_IP:
        {
            ...
            device_send_state_notify(DEVICE_STATE_WIFI_GO_IP, true);
        }
        break;
        case CODE_WIFI_ON_DISCONNECT:
        {
            LOG_I("[APP] [EVT] %s, CODE_WIFI_ON_DISCONNECT", __func__);
            device_send_state_notify(DEVICE_STATE_WIFI_DISCONNECT, true);
