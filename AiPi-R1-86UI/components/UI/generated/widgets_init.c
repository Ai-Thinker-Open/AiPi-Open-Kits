...
extern int screen_digital_clock_date_hour_value;
extern int screen_digital_clock_date_min_value;
extern int screen_digital_clock_date_sec_value;

void screen_digital_clock_date_timer(lv_timer_t *timer)
{
    clock_count_24(&screen_digital_clock_date_hour_value, &screen_digital_clock_date_min_value, &screen_digital_clock_date_sec_value);
    if (lv_obj_is_valid(guider_ui.screen_digital_clock_date))
    {
        lv_dclock_set_text_fmt(guider_ui.screen_digital_clock_date, "%d:%02d:%02d", screen_digital_clock_date_hour_value, screen_digital_clock_date_min_value, screen_digital_clock_date_sec_value);
    }
}
